...
export class AppComponent {
  ...
  constructor(public oidcSecurityService: OidcSecurityService, public readonly eventService: PublicEventsService, private route: ActivatedRoute, 
  ...
  ngOnInit() {
    ...
    // // .getIsAuthorized()
    // // .pipe(
    // // tap((e: boolean) => this._isAuthorized.next(e)),
    // // takeWhile((e: boolean) => !e)
    // // ).subscribe();
    // // this.checkLogin();
